...
contract ReportIdlePlayerFirstShuffleTest is Test {
    ...
    function test_reportIdlePlayer() public {
        assertEq(room.lastActionTimestamp(), 0);
        ...
        assertEq(room.lastActionTimestamp(), 1);
        ...
        assertEq(players[0].addr, address(0));
        ...
        assertEq(uint256(room.stage()), uint256(TexasHoldemRoom.GameStage.Idle)); // idle cause 1 player left
            // assertEq(room.getSeatPositionToPlayerIndex(0), 255);
    }
