...
contract PokerHandEvaluatorTest is Test {
    ...
    function test_bestHandRoyalFlush2() public view {
        // Royal Flush: 10, J, Q, K, A of the same suit
    ...
    function test_bestHandStraightFlush2() public view {
        // Straight Flush: 5 consecutive cards of the same suit
    ...
    function test_bestHandFourOfAKind2() public view {
        // Four of a Kind: 4 cards of the same rank
    ...
    function test_bestHandFullHouse2() public view {
        // Full House: 3 cards of one rank and 2 of another
    ...
    function test_bestHandFlush2() public view {
        // Flush: 5 cards of the same suit, not in sequence
    ...
    function test_bestHandStraight2() public view {
        // Straight: 5 consecutive cards of mixed suits
        // also has a three of a kind (but three of a kind is lower rank)
    ...
    function test_bestHandThreeOfAKind2() public view {
        // Three of a Kind: 3 cards of the same rank
    ...
    function test_bestHandTwoPair2() public view {
        // Two Pair: 2 cards of one rank, 2 of another
    ...
    function test_bestHandPair2() public view {
        // Pair: 2 cards of the same rank
    ...
    function test_bestHandHighCard2() public view {
        // High Card: When no other hand is made
