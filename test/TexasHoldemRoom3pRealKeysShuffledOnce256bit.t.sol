...
contract TexasHoldemRoom3pRealKeysShuffledOnceTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory c1p3bytes =
            hex"10c51fc72e0803cb9e161dc9ecb3cf0c0d0130bba7343dba7534c392db107512";
    ...
    function test_RealKeysShuffle3Players256bit() public {
        ...
        uint8[] memory cardIndexes = new uint8[](4);
        ...
        decryptionValues[1] = BigNumbers.init(
            hex"00d40895c805cf21b1e6d1c623c794dac2dea18332efdf7b6186dab02416ac41", false
        );
        decryptionValues[2] = BigNumbers.init(
            hex"e2513b112ca713e62152b58c526c110aeb0a3c8c28eb8a092bec641d53bea248", false
        );
        decryptionValues[3] = BigNumbers.init(
            hex"d9857023153343cbc20ddc637ddaf94f26fccbb041a55a60393e322472f2e158", false
        );
        ...
        cardIndexes[3] = 5;
        decryptionValues[0] = BigNumbers.init(
            hex"90f89e2bbb346cc1c12d5d1ad0ff5e757276de569d1cf6c6b9af7b9359c1ffd0", false
        );
        decryptionValues[1] = BigNumbers.init(
            hex"65c87905dfc39c3150db393a8f24869bf68080bfb668d8d4588a10d798a20b10", false
        );
        decryptionValues[2] = BigNumbers.init(
            hex"d1b4cd269b1927a177c6b8c2115657b78d693b55455b519be75a234b93a1ef91", false
        );
        decryptionValues[3] = BigNumbers.init(
            hex"82e589409f33fa840ae7b6f9620960910272592311bd7676fe658a36fccedcc4", false
        );
